...
document.getElementById('btn-deposit').addEventListener('click', () => {
  // get new and old deposit 
const inputDeposit = getInputValue('deposit-field');
const previousElementTextValue = getTextElementValue('deposit-total');
const totalDeposit = previousElementTextValue + inputDeposit;

// set deposit in total 
setTextElementValue('deposit-total', totalDeposit);
stroderInLocalStorage('deposit-total', totalDeposit);

// update blace 
const getPreviousBlace = getTextElementValue('balance-total');
const newTotalBlace = getPreviousBlace + inputDeposit;

setTextElementValue('balance-total',newTotalBlace);
stroderInLocalStorage('balance-total', newTotalBlace);
